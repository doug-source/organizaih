...
namespace App\Http\Requests\Customer\Strategy\Get;
...
class Plain implements Checker
{
    ...
    public function rules(): array
    {
        return [
            ...
            'search' => "nullable|string|max:{$this->customerNameMaxSize}"
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'search.max' => Str::of(__('validation-max', ['size' => $this->customerNameMaxSize]))->ucfirst()
        ];
    }
}
